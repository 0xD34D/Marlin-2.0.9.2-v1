...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  21.96,  47.38 }
    #define DEFAULT_Ki_LIST {   1.78,   9.04 }
    #define DEFAULT_Kd_LIST {  67.92, 62.11  }
  #else
    #define DEFAULT_Kp  10.1
    #define DEFAULT_Ki   0.62
    #define DEFAULT_Kd  41.5
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 45.02
  #define DEFAULT_bedKi 8.72
  #define DEFAULT_bedKd 154.89
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 66.5, 405 }
